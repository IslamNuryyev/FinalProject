...
@rem ##########################################################################
@rem
@rem  ClientServer startup script for Windows
@rem
@rem ##########################################################################
...
set DEFAULT_JVM_OPTS="--module-path" "%APP_HOME%\lib" "--module" "com.example.clientserver/com.example.clientserver.server"
...
@rem Execute ClientServer
"%JAVA_EXE%" %JAVA_OPTS% %CLIENT_SERVER_OPTS% %DEFAULT_JVM_OPTS% %CMD_LINE_ARGS%
